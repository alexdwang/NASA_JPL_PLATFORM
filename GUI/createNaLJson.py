...
def save_library_to_json(INPUT_VOLTAGE_SOURCE, CIRCUIT_CORE, SCALE, FUNCTIONS, INPUT, OUTPUT,
...
INPUT_VOLTAGE_SOURCE = {PART_AD590: ['VIN 2 0 DC 0V',
                        ...
                        PART_LM111 + Supply_Current: ['VG1 99 0 DC 0V',
                                                     ...
                                                     'VAM4 5 6',
                                                     'VS3 97 0 DC -15V'],
                        PART_LM111 + Positive_Input_Bias_Current: ['VAM5 99 0 DC 0V',
                                                                 'VAM4 98 0',
                                                                 'VS2 6 0 DC 0V',
                                                                 'VS3 97 0 DC -15V'],
                        PART_LM111 + Input_Offset_Current: ['VAM5 99 0 DC 0V',
                                                                 'VAM4 98 0',
                                                                 'VS2 6 0 DC 0V',
                                                                 'VS3 97 0 DC -15V'],
                        PART_LM111 + Negative_Input_Bias_Current: ['VAM5 99 0 DC 0V',
                                                                 'VAM4 98 0',
                                                                 'VS2 6 0 DC 0V',
                                                                 'VS3 97 0 DC -15V'],
                        ...
                        PART_LM193 + Input_Offset_Voltage: ['VCC 5 0 DC 0V',
                                                            'VOUT 4 0 DC 1.4V',
                                                            'VOS 6 0 DC 0V'],
                        PART_LM193 + Positive_Input_Bias_Current: ['VCC 5 0 DC 0V',
                                                            'VOUT 4 0 DC 1.4V'],
                        PART_LM193 + Negative_Input_Bias_Current: ['VCC 5 0 DC 0V',
                                                            'VOUT 4 0 DC 1.4V'],
                        PART_LM193 + Input_Offset_Current: ['VCC 5 0 DC 0V',
                                                            'VOUT 4 0 DC 1.4V'],
                        PART_LM193 + Supply_Current: ['VCC 5 0 DC 0V',
                                                            'VOUT 4 0 DC 1.4V'],
                        PART_LP2953: ['V2 2 0 DC 6V',
                                      'I1 1 2 DC 0A'],
...
OUTPUT = {PART_AD590: {Temperature: ['+ V(2)',
          ...
          PART_LP2953: {Output_Voltage: ['+ V(1)',
                                         '+ V(2)']},
...
SUBCIRCUIT = {PART_AD590: {SIMULATION_MODEL: ['.subckt AD590 2 20',
              ...
              PART_LM193: {SIMULATION_MODEL: ['.subckt LM193_sc 21 22 23 24',
                           ...
                           SIMULATION_SOURCE: ['.subckt LM193_sc 21 22 23 24',
                                               ...
                                               '',
                                               '.ends']},
              PART_LP2953: {SIMULATION_MODEL: ['.subckt BG1_sc VCC VEE VREF',
                                              '',
                                              '*Resistance: R<name> <+ node> <- node> [model name] <value>',
                                              'R4 4 3 30k',
                                              'R3 4 VEE 30k',
                                              ...
                                              '.ends OPAMP1_sc'],
                            SIMULATION_SOURCE: ['.subckt BG1_sc VCC VEE VREF',
                                              '',
                                              '*NPN',
                                              'D1 1 VEE DMODNPN 0.05',
                                              'D2 1 3 DMODNPN 1',
...
if __name__=='__main__':
    ...
    save_library_to_json(INPUT_VOLTAGE_SOURCE, CIRCUIT_CORE, SCALE, FUNCTIONS, INPUT, OUTPUT,
                         SUBCIRCUIT, LIBRARY_TID_LEVEL_MODEL, LIBRARY_JFET)

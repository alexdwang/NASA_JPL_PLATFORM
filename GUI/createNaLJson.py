...
OUTPUT = {PART_AD590: {Temperature: ['+ V(2)',
          ...
          PART_LP2953: {Output_Voltage_With_Vin_6V: ['+ V(1)',
                                         '+ V(2)'],
                        Reference_Voltage_With_Vin_6V: ['+ V(3)',
                                            '+ V(2)'],
                        Output_Voltage_With_Vin_23V: ['+ V(1)',
                                                     '+ V(2)'],
                        Reference_Voltage_With_Vin_23V: ['+ V(3)',
                                                        '+ V(2)'],
                        Output_Voltage_With_Vin_30V: ['+ V(1)',
                                         '+ V(2)'],
                        Reference_Voltage_With_Vin_30V: ['+ V(3)',
                                            '+ V(2)']
                        },

...
SPECIFICATION = {createNaLJson.PART_AD590: {createNaLJson.Nonlinearity: [-1,1],
                 ...
                 createNaLJson.PART_LM111: {createNaLJson.Supply_Current: [0, 6e-3],
                                            ...
                                            createNaLJson.Input_Offset_Voltage: [-3e-3, 3e-3],
                                            createNaLJson.Input_Offset_Current: [-1e-8, 1e-8],
                                            createNaLJson.Positive_Input_Bias_Current: [-1e-7, 1e-10],
                                            createNaLJson.Negative_Input_Bias_Current: [-1e-7, 1e-10],
                                            "Dataset": [15]},
